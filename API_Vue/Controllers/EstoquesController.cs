...
namespace API_Vue.Controllers
{
    public class EstoquesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EstoqueId,CodProduto,Quantidade")] Estoque estoque)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EstoqueId,CodProduto,Quantidade")] Estoque estoque)
        {
